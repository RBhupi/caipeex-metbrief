...
\includegraphics[width=3in]{fig/3Dhum_prof620_a1}
...
\centering
%trim=8cm 1cm 10cm 5cm, clip
\includegraphics[width=2.5in, height=2.0in]{manual_fig/radarppi}
\includegraphics[width=2.5in, height=2.0in]{manual_fig/radar24}
\caption{Radar images close range dBZ (left) hourly accumulated rainfall (right).}
\end{figure}
