...
\centering
%trim=8cm 1cm 10cm 5cm, clip
\includegraphics[width=3in, height=2.0in]{manual_fig/radarppi}
\includegraphics[width=3in, height=2.0in]{manual_fig/radar_maxdbz}
\caption{Radar images close range dBZ (left) Max dBZ (right).}
\end{figure}
