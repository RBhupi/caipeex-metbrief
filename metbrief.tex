...
\includegraphics[width=3in]{manual_fig/backward.png}
\includegraphics[width=3in]{manual_fig/forward.png}
...
\centering
%trim=8cm 1cm 10cm 5cm, clip
\includegraphics[width=3in]{fig_obs/rain-gauge_output.pdf}
\caption{Rain gauge network.}
\end{figure}
